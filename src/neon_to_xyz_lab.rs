...
>(
    ...
    while cx + 16 < width as usize {
        ...
        if USE_ALPHA {
            ...
            let mut a_low_high = vmulq_n_f32(vcvtq_f32_u32(vmovl_high_u16(a_low)), 1f32 / 255f32);
            ...
            let mut a_high_low = vmulq_n_f32(
            ...
            let mut a_high_high = vmulq_n_f32(vcvtq_f32_u32(vmovl_high_u16(a_high)), 1f32 / 255f32);
